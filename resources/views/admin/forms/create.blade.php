...
<div class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Create Dynamic Form</h1>
    ...
    <form action="{{ route('admin.forms.store') }}" method="POST" class="space-y-6" x-data="{
        fields: [{ label: '', type: 'text', is_required: false, options: '' }],
        addField() {
        ...
        <div class="p-4 border rounded-md bg-white shadow-sm">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" id="description" rows="2" placeholder=""
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.forms.index') }}" class="text-gray-600 hover:text-gray-900">Cancel</a>
            <button type="submit"
                    class="ml-3 px-6 py-2 bg-indigo-600 text-white font-semibold rounded hover:bg-indigo-700 transition">
                Create Form
            </button>
        </div>
    </form>
